...
const hardwareCatalog = [
  ...
  },
  {
    ...
    environments: ['Indoor', 'Outdoor'],
    applications: ['HVAC', 'Agriculture', 'Logistics', 'Real Estate'],
    keySpecs: [
      '10km+ transmission range via private LoRaWAN mesh (No Wi-Fi needed)',
      'Indoor IAQ tracking: CO₂, TVOC, PM2.5, Formaldehyde, and Occupancy',
      'Agricultural arrays: Soil Saturation, EC, pH, and Weather hookups',
      'Cold-Chain probes: FDA 21 CFR Part 11 compliant data buffering'
    ]
  }
];
