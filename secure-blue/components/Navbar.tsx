            ...
            <div key={link.name} className="relative group">
              {link.subGroups ? (
                ...
                <div className="flex items-center">
                  ...
                  {/* Desktop Mega-Menu */}
                  <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-[540px] bg-zinc-950 border border-zinc-800 shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 flex flex-col z-50 p-6 rounded-sm">
